...
from oci_spec.image.v1 import Manifest
from oci_spec.digest.exceptions import ErrDigestInvalidFormat
import os
import pytest
...
<<<<<<< master:opencontainers/tests/test_manifest.py
    """test creation of an opencontainers Manifest"""
=======
    """test creation of an oci_spec Manifest
    """
>>>>>>> Version 0.1.3:oci_spec/tests/test_manifest.py
    manifest = Manifest()
