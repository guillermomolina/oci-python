...
from oci_spec.digest import Parse, NewDigestFromEncoded
...
<<<<<<< master:opencontainers/tests/test_digest.py
    """test creation of an opencontainers Digest"""
=======
    """test creation of an oci_spec Digest
    """
>>>>>>> Version 0.1.3:oci_spec/tests/test_digest.py
