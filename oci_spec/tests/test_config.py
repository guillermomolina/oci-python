...
from oci_spec.image.v1 import Image
import os
import pytest
...
<<<<<<< master:opencontainers/tests/test_config.py
    """test creation of an opencontainers Image"""
=======
    """test creation of an oci_spec Image
    """
>>>>>>> Version 0.1.3:oci_spec/tests/test_config.py
    image = Image()
