...
from oci_spec.image.v1 import Index
import os
import pytest
...
<<<<<<< master:opencontainers/tests/test_imageindex.py
    """test creation of an opencontainers Index"""
=======
    """test creation of an oci_spec Index
    """
>>>>>>> Version 0.1.3:oci_spec/tests/test_imageindex.py
    index = Index()
